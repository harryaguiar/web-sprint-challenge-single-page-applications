describe("Testing the pizza order form", () => {
    ...
    it("Fills out the form", () => {
        const name = "Harrison Aguiar"
        const address = "52 Eat Pizza";
    //     const price1 = "$17.99";
    // const price2 = "$17.99";
    // const price3 = "$17.99";
    ...
    cy.get('[name="pepperoni"], [name="pineapple"]').check().should('be.checked') //and it passes

    //select a size so the form can be submited
    cy.get('#select-tag').select(`Small`).should('have.value', "small")
